...
require (
	...
	github.com/tliron/exturl v0.4.5
	github.com/tliron/go-ard v0.2.18
	github.com/tliron/go-transcribe v0.3.6
	github.com/tliron/kutil v0.3.27
	github.com/tliron/yamlkeys v1.3.7
)
